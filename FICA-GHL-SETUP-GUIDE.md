# FICA Tip Credit Campaign - GHL Setup Guide

## ✅ What's Been Done
- **Tag Created:** `fica-prospect` (ID: 7aPjBvkagrcYZ8edwF6d)
- **Workflow JSON:** Saved to `fica-ghl-workflow-import.json`
...
4. Name: `FICA Tip Credit Campaign`
5. Click **Create**
...
Copy and paste each email below into GHL:
...
| Day | Email | Subject |
|-----|-------|---------|
| 0 | 1 | A quick question about your payroll taxes |
| 1 | 2 | That tax credit I mentioned... |
| 3 | 3 | The experts behind FICA Tip Credit recovery |
| 5 | 4 | It's not a deduction — it's a check |
| 7 | 5 | The #1 mistake restaurants make with the FICA Tip Credit |
| 9 | 6 | Why timing matters on this... |
| 11 | 7 | About Fintitan's service rates... |
| 13 | 8 | {{contact.first_name}}, you might be leaving $80K+ on the table |
| 15 | 9 | Last call for your FICA Tip Credit evaluation |
| 17 | 10 | Closing your file |

## 🚀 How to Use

1. **Publish the workflow** in GHL
2. **Add contacts to the campaign** by applying the `fica-prospect` tag
3. **Warm-up schedule:** Start with 20 contacts/day for the first week
4. **Monitor:** Track opens, clicks, and replies in GHL

## ⚠️ Important Notes

- **From Name:** Set this to your name in GHL settings
- **Reply-to:** Make sure replies go to your email
- **Unsubscribe:** GHL automatically adds unsubscribe links
- **Tracking:** All link clicks to Fintitan will be tracked

## 🔗 Fintitan Affiliate Link
