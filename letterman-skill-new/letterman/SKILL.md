...
|-------------|-----|--------|
| BizBuzz Calgary | 69c6f96237ba49fb69a44b52 | calgarybizguide.com/news |
| Stampede City Buzz | 69b67eb447872b28b4e043dc | www.stampedecitybuzz.com |

**Rule:** Use only these two publication IDs for Michelle's Letterman work unless Michelle explicitly provides a new one.
...
- **Location names** (Calgary, Alberta, Canada)
...
1. Publication name (BizBuzz Calgary or Stampede City Buzz.)
...
```json
{
  "publication": "Stampede City Buzz",
  "stories": [
    {
      "id": 1,
