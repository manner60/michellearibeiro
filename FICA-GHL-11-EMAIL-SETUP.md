# FICA Tip Credit Campaign - GHL Setup Guide (11 Emails)

## ✅ What's Ready
- **Tag:** `fica-prospect` (already created in GHL)
- **11-email sequence:** Complete copy below
- **Trigger:** Tag-based workflow
...
3. Name: `FICA Tip Credit Campaign`
4. Click **Create**

### Step 2: Add Trigger
1. Click **Add Trigger**
2. Select **Tag**
3. Choose: `fica-prospect`
4. Action: `Added to Contact`
5. Click **Save**

### Step 3: Add 11 Email Steps

---

## EMAIL 1 (Day 0 - Immediate)
**Subject:** Your FICA Tip Credit Executive Summary

**Body:**
```
Hi {{contact.first_name}},

I wanted to share something that could put significant money back into your business.

The FICA Tip Credit is a federal tax credit designed specifically for restaurants, bars, and hotels that employ tipped workers. Most operators don't realize they're overpaying payroll taxes — and that the government has a program to refund a portion of those taxes directly to you.

Here's what you need to know:

**What it is:** A dollar-for-dollar credit against the employer's share of FICA taxes paid on employee tips

**Who qualifies:** Any business with tipped employees (restaurants, bars, hotels, caterers)

**How much:** The average restaurant with $500K in annual tips recovers $25,000-$50,000+ per year. You can claim up to 3 years retroactively.

**The catch:** Most CPAs miss this credit because it requires specialized expertise to calculate and document properly.

I've partnered with Fintitan, a team that specializes exclusively in tax credit recovery. They've recovered over $2.1 billion for businesses like yours.

**Want to see how much you're owed?**
→ https://fintitan.com/services/fica-tip-credit/schedule?referrer=MRIBEIRO

They offer a free, no-obligation evaluation. Takes about 60 seconds to get a preliminary estimate.
...
| Day | Email | Subject |
|-----|-------|---------|
| 0 | 1 | Your FICA Tip Credit Executive Summary |
| 1 | 2 | A quick question about your payroll taxes |
| 2 | 3 | That tax credit I mentioned... |
| 4 | 4 | The experts behind FICA Tip Credit recovery |
| 6 | 5 | It's not a deduction — it's a check |
| 8 | 6 | The #1 mistake restaurants make with the FICA Tip Credit |
| 10 | 7 | Why timing matters on this... |
| 12 | 8 | About Fintitan's service rates... |
| 14 | 9 | {{contact.first_name}}, you might be leaving $80K+ on the table |
| 16 | 10 | Last call for your FICA Tip Credit evaluation |
| 18 | 11 | Closing your file |
...
- [ ] Domain DNS records verified in GHL
- [ ] Workflow created and published
- [ ] Test contact added with `fica-prospect` tag
- [ ] First test email received and looks good
- [ ] Warm-up plan: 20 contacts/day for first week
- [ ] Tracking links working (Fintitan affiliate link)

---

## 🔗 Important Links

**Fintitan Affiliate URL:**
`https://fintitan.com/services/fica-tip-credit/schedule?referrer=MRIBEIRO`
